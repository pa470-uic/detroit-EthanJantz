...
It looks like the number of arms length sales has been decreasing over the study period. `cmfproperty` has its own method for determining these sales, but I also utilized a cutoff of $2,500 while preprocessing the data based on the documentation for the package. This is an arbitrary decision, and I could use some other variables in the provided data to help in this process such as the ECF variable in the sales data.
